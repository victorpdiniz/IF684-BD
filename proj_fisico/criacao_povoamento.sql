...
CREATE TABLE RECEITA_REMEDIO (
    ID_RECEITA NUMBER,
    COD NUMBER,
    CONSTRAINT PK_REMEDIO_RECEITA PRIMARY KEY (ID_RECEITA, COD),
    CONSTRAINT FK_RECEITA FOREIGN KEY (ID_RECEITA) REFERENCES RECEITA(ID_RECEITA),
    CONSTRAINT FK_REMEDIO FOREIGN KEY (COD) REFERENCES REMEDIO(COD)
);
...
INSERT INTO CLINICA (ID_CLINICA, CNPJ, NOME) VALUES (6, '78654321987654', 'Clinica Novo Horizonte');
...
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('14485019039', 'Felipe Torres', 'Santander', 20);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('64328028901', 'Joao Marcelo', 'Amil', 20);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('45563256413', 'Alberto Guevara', 'Amil', 20);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('92434126634', 'Victor Diniz', 'Cassi', 20);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('68059553607', 'Fábio Miranda', 'Cassi', 19);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('19152913996', 'Joao Victor Lopes', 'Amil', 20);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('66378226636', 'Felipe Santos', 'Sulamérica 100', 21);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('31897832167', 'Carlos Ferreira', 'Unimed', 34);
INSERT INTO PACIENTE (CPF, NOME, CONVENIO, IDADE) VALUES ('29187654321', 'Larissa Souza', 'Bradesco Saúde', 29);
...
INSERT INTO RECEITA (ID_RECEITA, CPF_MEDICO, CPF_PACIENTE) VALUES (4, '92434126634', '68059553607');
INSERT INTO RECEITA (ID_RECEITA, CPF_MEDICO, CPF_PACIENTE) VALUES (5, '45563256413', '68059553607');
INSERT INTO RECEITA (ID_RECEITA, CPF_MEDICO, CPF_PACIENTE) VALUES (6, '12657045898', '19152913996');
INSERT INTO RECEITA (ID_RECEITA, CPF_MEDICO, CPF_PACIENTE) VALUES (7, '12657045898', '92434126634');
INSERT INTO RECEITA (ID_RECEITA, CPF_MEDICO, CPF_PACIENTE) VALUES (8, '19152913996', '14485019039');
INSERT INTO RECEITA (ID_RECEITA, CPF_MEDICO, CPF_PACIENTE) VALUES (9, '19152913996', '68059553607');

INSERT INTO REMEDIO (COD) VALUES (1);
INSERT INTO REMEDIO (COD) VALUES (2);
INSERT INTO REMEDIO (COD) VALUES (3);
INSERT INTO REMEDIO (COD) VALUES (4);
INSERT INTO REMEDIO (COD) VALUES (5);
INSERT INTO REMEDIO (COD) VALUES (6);
INSERT INTO REMEDIO (COD) VALUES (7);
INSERT INTO REMEDIO (COD) VALUES (8);
INSERT INTO REMEDIO (COD) VALUES (9);

INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (1, 2);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (2, 4);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (3, 7);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (4, 3);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (5, 9);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (6, 8);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (7, 1);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (8, 5);
INSERT INTO RECEITA_REMEDIO (ID_RECEITA, COD) VALUES (9, 6);
...
INSERT INTO CONSULTA (CPF_MEDICO, CPF_PACIENTE, DATA_CONSULTA)
VALUES ('92434126634', '68059553607', TO_DATE('2023-09-25', 'YYYY-MM-DD'));
INSERT INTO CONSULTA (CPF_MEDICO, CPF_PACIENTE, DATA_CONSULTA)
